...
/**
 * 齿轮（heroicons 24/outline `cog-6-tooth`，与其余图标同一套描边）。
 *
 * 之前那版是手写的 8 齿路径：齿太浅、内孔不成同心圆，15px 下糊成一朵花，
 * 看着像「坏掉的螺丝」。6 齿 + 规整内圆在小尺寸下才立得住——这正是
 * VS Code 自己的 codicon 齿轮、以及 heroicons 官方取的都是 6 齿的原因。
 */
